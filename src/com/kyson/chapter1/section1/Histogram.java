...
/**
 * 
 * 1.1.32 直方图。假设标准输入流中含有一系列 double 值。 编写一段程序，从命令行接受一个整数 N 和 两个 double 值 l 和 r。 将
 * (l，r) 分为 N 段并使用 StdDraw 画出输入流中的值落入每段的数量的直方图。 1.1.32 Histogram. Suppose that
 * the standard input stream is a sequence of double values. Write a program
 * that takes an integer N and two double values l and r from the command line
 * and uses StdDraw to plot a histogram of the count of the numbers in the
 * standard input stream that fall in each of the N intervals defined by
...
public class Histogram {
	...
	public static void main(String[] args) {
		 ...
		 * 
		 * Arrays.sort(a); for (int i = 0; i < N; i++) { double x = 1.0*i/N;
		 * double y = a[i]/2.0; double rw = 0.5/N; double rh = a[i]/2.0;
		 * 
